...
import bcrypt from './backend/node_modules/bcrypt/index.js';
...
async function main() {
  ...
  const post3 = await prisma.post.upsert({
    ...
    create: {
      ...
      description:
        'Draft: Building an NLP pipeline to extract clinical urgency signals from freetext ER triage notes. Looking for ER physicians with annotation expertise.',

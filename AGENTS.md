# HEALTH AI — Codex Master Reference
...
*Bu dosya her Codex session'ında ilk okunacak referans kaynaktır.*
*Dosyayı güncellemeden önce: `git add AGENTS.md && git commit -m "update: AGENTS.md"`*
